#ifndef __5AxwALAOwAiCt73xCkp15B_h__
#define __5AxwALAOwAiCt73xCkp15B_h__
...
#ifndef struct_tag_92EVd9XKm6NA2yfmfFtMS
#define struct_tag_92EVd9XKm6NA2yfmfFtMS

struct tag_92EVd9XKm6NA2yfmfFtMS
{
  char_T f1[4];
  char_T f2[8];
  char_T f3[6];
...
#endif                                 /* struct_tag_92EVd9XKm6NA2yfmfFtMS */

#ifndef typedef_cell
#define typedef_cell

typedef struct tag_92EVd9XKm6NA2yfmfFtMS cell;
...
typedef struct tag_hEVPFOGCYhJIualz6vMiMC b_cell;

#endif                                 /* typedef_b_cell */

#ifndef struct_tag_qWXpA84tzIgYkkUCcMt1JF
#define struct_tag_qWXpA84tzIgYkkUCcMt1JF

struct tag_qWXpA84tzIgYkkUCcMt1JF
{
  char_T f1;
  real_T f2;
  char_T f3[2];
...
#endif                                 /* struct_tag_qWXpA84tzIgYkkUCcMt1JF */

#ifndef typedef_c_cell
#define typedef_c_cell

typedef struct tag_qWXpA84tzIgYkkUCcMt1JF c_cell;
...
#ifndef struct_tag_6efCIkJetNTa2AjfHEYSHB
#define struct_tag_6efCIkJetNTa2AjfHEYSHB

struct tag_6efCIkJetNTa2AjfHEYSHB
{
  char_T Value[3];
};

#endif                                 /* struct_tag_6efCIkJetNTa2AjfHEYSHB */

#ifndef typedef_s_6efCIkJetNTa2AjfHEYSHB
#define typedef_s_6efCIkJetNTa2AjfHEYSHB

typedef struct tag_6efCIkJetNTa2AjfHEYSHB s_6efCIkJetNTa2AjfHEYSHB;

#endif                                 /* typedef_s_6efCIkJetNTa2AjfHEYSHB */

#ifndef struct_tag_n38Cf2WbvD2qmAUOOX0WEC
#define struct_tag_n38Cf2WbvD2qmAUOOX0WEC

struct tag_n38Cf2WbvD2qmAUOOX0WEC
{
  char_T Value[9];
};

#endif                                 /* struct_tag_n38Cf2WbvD2qmAUOOX0WEC */

#ifndef typedef_s_n38Cf2WbvD2qmAUOOX0WEC
#define typedef_s_n38Cf2WbvD2qmAUOOX0WEC

typedef struct tag_n38Cf2WbvD2qmAUOOX0WEC s_n38Cf2WbvD2qmAUOOX0WEC;

#endif                                 /* typedef_s_n38Cf2WbvD2qmAUOOX0WEC */

#ifndef struct_tag_bhoJb8DGvrqWQvPGAcJgFD
#define struct_tag_bhoJb8DGvrqWQvPGAcJgFD

struct tag_bhoJb8DGvrqWQvPGAcJgFD
{
  char_T Value[10];
};

#endif                                 /* struct_tag_bhoJb8DGvrqWQvPGAcJgFD */

#ifndef typedef_s_bhoJb8DGvrqWQvPGAcJgFD
#define typedef_s_bhoJb8DGvrqWQvPGAcJgFD

typedef struct tag_bhoJb8DGvrqWQvPGAcJgFD s_bhoJb8DGvrqWQvPGAcJgFD;

#endif                                 /* typedef_s_bhoJb8DGvrqWQvPGAcJgFD */
...
#ifndef struct_tag_4f3SvLYqWshzJtR2npDMBE
#define struct_tag_4f3SvLYqWshzJtR2npDMBE

struct tag_4f3SvLYqWshzJtR2npDMBE
{
  cell _data;
};

#endif                                 /* struct_tag_4f3SvLYqWshzJtR2npDMBE */

#ifndef typedef_s_4f3SvLYqWshzJtR2npDMBE
#define typedef_s_4f3SvLYqWshzJtR2npDMBE

typedef struct tag_4f3SvLYqWshzJtR2npDMBE s_4f3SvLYqWshzJtR2npDMBE;

#endif                                 /* typedef_s_4f3SvLYqWshzJtR2npDMBE */
...
#ifndef struct_tag_m1JmDgTSsmfrDGeetrMKOB
#define struct_tag_m1JmDgTSsmfrDGeetrMKOB

struct tag_m1JmDgTSsmfrDGeetrMKOB
{
  c_cell _data;
};

#endif                                 /* struct_tag_m1JmDgTSsmfrDGeetrMKOB */

#ifndef typedef_s_m1JmDgTSsmfrDGeetrMKOB
#define typedef_s_m1JmDgTSsmfrDGeetrMKOB

typedef struct tag_m1JmDgTSsmfrDGeetrMKOB s_m1JmDgTSsmfrDGeetrMKOB;

#endif                                 /* typedef_s_m1JmDgTSsmfrDGeetrMKOB */
...
#ifndef struct_tag_FYyGgBGJEn5bMwhLZFIhMB
#define struct_tag_FYyGgBGJEn5bMwhLZFIhMB

struct tag_FYyGgBGJEn5bMwhLZFIhMB
{
  int32_T isInitialized;
  boolean_T TunablePropsChanged;
  cell_wrap inputVarSize[1];
  char_T ModulationPhaseOffset[4];
  real_T CustomPhaseOffset;
  real_T SamplesPerSymbol;
  real_T DampingFactor;
  real_T NormalizedLoopBandwidth;
  real32_T pProportionalGain;
  real32_T pIntegratorGain;
  real32_T pDigitalSynthesizerGain;
  real32_T pPhase;
  creal32_T pPreviousSample;
  real32_T pActualPhaseOffset;
  real32_T pLoopFilterState;
  real32_T pIntegFilterState;
  real32_T pDDSPreviousInput;
};

#endif                                 /* struct_tag_FYyGgBGJEn5bMwhLZFIhMB */

#ifndef typedef_comm_CarrierSynchronizer
#define typedef_comm_CarrierSynchronizer

typedef struct tag_FYyGgBGJEn5bMwhLZFIhMB comm_CarrierSynchronizer;

#endif                                 /* typedef_comm_CarrierSynchronizer */

#ifndef typedef_InstanceStruct_5AxwALAOwAiCt73xCkp15B
#define typedef_InstanceStruct_5AxwALAOwAiCt73xCkp15B

typedef struct {
  SimStruct *S;
  comm_CarrierSynchronizer sysobj;
  boolean_T sysobj_not_empty;
  creal32_T phaseCorrection[40000];
  void *emlrtRootTLSGlobal;
  creal32_T (*u0)[40000];
  creal32_T (*b_y0)[40000];
} InstanceStruct_5AxwALAOwAiCt73xCkp15B;

#endif                                 /* typedef_InstanceStruct_5AxwALAOwAiCt73xCkp15B */
...
extern void method_dispatcher_5AxwALAOwAiCt73xCkp15B(SimStruct *S, int_T method,
  void* data);
