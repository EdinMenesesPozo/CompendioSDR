...
class lab02_sdr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab02_sdr")
        ...
        self.rtlsdr_source_0.set_center_freq(102.3e6, 0)
...
def main(top_block_cls=lab02_sdr, options=None):
